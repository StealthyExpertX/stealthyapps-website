...
const cues = {
  ar: ['طلب توظيف آخر؟ املأ البيانات التي حفظتها من قبل.', 'بنقرة واحدة، املأ الاسم والبريد والهاتف وأضف السيرة الذاتية المحفوظة.', 'راجع كل تغيير. تراجع عند الحاجة. أنت من يقرر متى يرسل النموذج.', 'يدعم القوائم المنسدلة ومربعات الاختيار والحقول التي تظهر لاحقًا.', 'ابدأ مجانًا مع 3 ملفات شخصية. تبلغ تكلفة Pro مدى الحياة 39.99 دولارًا أمريكيًا، وتتوفر أيضًا خطط شهرية وسنوية.'],
  cs: ['Další žádost o práci? Vyplňte údaje, které už máte uložené.', 'Jedním kliknutím doplňte jméno, e-mail, telefon a přiřazený životopis.', 'Zkontrolujte každou změnu. V případě potřeby ji vraťte. Odeslání je na vás.', 'Funguje s nabídkami, zaškrtávacími políčky i poli, která se objeví později.', 'Začněte zdarma se 3 profily. Doživotní Pro stojí 39,99 USD; k dispozici jsou i měsíční a roční plány.'],
  de: ['Noch eine Bewerbung? Füllen Sie die Angaben aus, die Sie bereits gespeichert haben.', 'Ein Klick füllt Name, E-Mail, Telefonnummer und den passenden Lebenslauf aus.', 'Prüfen Sie jede Änderung. Machen Sie sie bei Bedarf rückgängig. Sie entscheiden, wann Sie absenden.', 'Funktioniert mit Dropdowns, Kontrollkästchen und später eingeblendeten Feldern.', 'Starten Sie kostenlos mit 3 Profilen. Pro auf Lebenszeit kostet 39,99 US-Dollar; Monats- und Jahrespläne sind ebenfalls verfügbar.'],
  el: ['Άλλη μία αίτηση εργασίας; Συμπληρώστε τα στοιχεία που έχετε ήδη αποθηκεύσει.', 'Με ένα κλικ συμπληρώνονται όνομα, email, τηλέφωνο και το αντίστοιχο βιογραφικό.', 'Ελέγξτε κάθε αλλαγή. Αναιρέστε αν χρειάζεται. Εσείς αποφασίζετε πότε θα γίνει η υποβολή.', 'Λειτουργεί με αναπτυσσόμενες λίστες, πλαίσια ελέγχου και πεδία που εμφανίζονται αργότερα.', 'Ξεκινήστε δωρεάν με 3 προφίλ. Το Pro εφ’ όρου ζωής κοστίζει 39,99 δολάρια ΗΠΑ· υπάρχουν επίσης μηνιαία και ετήσια προγράμματα.'],
  en: ['Another job application? Fill the details you already saved.', 'One click fills your name, email, and phone, then matches your resume.', 'Review every change. Undo if needed. You decide when to submit.', 'Works with dropdowns, checkboxes, and fields that appear later.', 'Start with 3 profiles free. Lifetime Pro is $39.99; monthly and yearly plans are also available.'],
  ...
  fr: ['Encore une candidature ? Remplissez les informations déjà enregistrées.', 'Un clic remplit votre nom, votre e-mail et votre téléphone, puis associe votre CV.', 'Vérifiez chaque modification. Annulez si nécessaire. Vous décidez quand envoyer.', 'Fonctionne avec les listes déroulantes, les cases à cocher et les champs qui apparaissent plus tard.', 'Commencez gratuitement avec 3 profils. Pro à vie coûte 39,99 $ US; des formules mensuelles et annuelles sont aussi disponibles.'],
  hi: ['एक और नौकरी आवेदन? पहले से सेव की गई जानकारी भरें।', 'एक क्लिक में नाम, ईमेल और फ़ोन भरें, फिर सेव किया हुआ रिज़्यूमे जोड़ें।', 'हर बदलाव जाँचें। ज़रूरत हो तो वापस लें। कब सबमिट करना है, यह आप तय करें।', 'ड्रॉपडाउन, चेकबॉक्स और बाद में दिखने वाले फ़ील्ड पर भी काम करता है।', '3 प्रोफ़ाइल के साथ मुफ़्त शुरू करें। लाइफ़टाइम Pro की कीमत $39.99 है; मासिक और वार्षिक प्लान भी उपलब्ध हैं।'],
  id: ['Melamar pekerjaan lagi? Isi data yang sudah Anda simpan.', 'Satu klik mengisi nama, email, dan telepon, lalu mencocokkan CV Anda.', 'Periksa setiap perubahan. Batalkan jika perlu. Anda menentukan kapan formulir dikirim.', 'Berfungsi untuk menu pilihan, kotak centang, dan kolom yang muncul belakangan.', 'Mulai gratis dengan 3 profil. Pro seumur hidup seharga US$39,99; paket bulanan dan tahunan juga tersedia.'],
  it: ['Un’altra candidatura? Compila i dati che hai già salvato.', 'Un clic inserisce nome, email e telefono, poi abbina il CV.', 'Controlla ogni modifica. Annulla se serve. Decidi tu quando inviare.', 'Funziona con menu a discesa, caselle di controllo e campi che compaiono dopo.', 'Inizia gratis con 3 profili. Pro a vita costa 39,99 USD; sono disponibili anche piani mensili e annuali.'],
  ja: ['また求人に応募しますか？保存済みの情報をまとめて入力。', 'ワンクリックで氏名、メール、電話番号を入力し、保存した履歴書を割り当てます。', '変更内容を確認。必要なら元に戻せます。送信するタイミングは自分で決められます。', 'プルダウン、チェックボックス、後から表示される項目にも対応。', '3プロフィールまで無料。Proの買い切りは39.99米ドル。月額・年額プランも選べます。'],
  ko: ['또 채용 지원서를 작성하시나요? 저장해 둔 정보를 바로 채우세요.', '한 번 클릭하면 이름, 이메일, 전화번호를 입력하고 저장한 이력서를 연결합니다.', '모든 변경 내용을 확인하고 필요하면 실행 취소하세요. 제출 시점은 직접 정합니다.', '드롭다운, 체크박스, 나중에 나타나는 필드도 지원합니다.', '프로필 3개까지 무료입니다. 평생 Pro는 미화 39.99달러이며, 월간 및 연간 요금제도 있습니다.'],
  nl: ['Weer een sollicitatie? Vul de gegevens in die u al hebt opgeslagen.', 'Eén klik vult naam, e-mail en telefoon in en koppelt uw opgeslagen cv.', 'Controleer elke wijziging. Maak zo nodig ongedaan. U bepaalt wanneer u verstuurt.', 'Werkt met keuzelijsten, selectievakjes en velden die later verschijnen.', 'Start gratis met 3 profielen. Pro levenslang kost US$ 39,99; maand- en jaarabonnementen zijn ook beschikbaar.'],
  pl: ['Kolejne podanie o pracę? Uzupełnij zapisane wcześniej dane.', 'Jedno kliknięcie wpisuje imię i nazwisko, e-mail i telefon oraz dopasowuje zapisane CV.', 'Sprawdź każdą zmianę. W razie potrzeby ją cofnij. To Ty decydujesz, kiedy wysłać formularz.', 'Działa z listami, polami wyboru i polami pojawiającymi się później.', 'Zacznij bezpłatnie z 3 profilami. Dożywotni Pro kosztuje 39,99 USD; dostępne są też plany miesięczne i roczne.'],
  pt_BR: ['Mais uma candidatura? Preencha os dados que você já salvou.', 'Um clique preenche nome, e-mail e telefone e associa o currículo salvo.', 'Revise cada mudança. Desfaça se precisar. Você decide quando enviar.', 'Funciona com listas, caixas de seleção e campos que aparecem depois.', 'Comece grátis com 3 perfis. O Pro vitalício custa US$ 39,99; também há planos mensal e anual.'],
  ru: ['Снова заполняете анкету на вакансию? Подставьте уже сохранённые данные.', 'Одно нажатие заполняет имя, почту и телефон и подбирает сохранённое резюме.', 'Проверьте каждое изменение. При необходимости отмените его. Когда отправлять форму, решаете вы.', 'Работает со списками, флажками и полями, которые появляются позже.', 'Начните бесплатно с 3 профилями. Пожизненный Pro стоит 39,99 долл. США; также доступны месячный и годовой планы.'],
  sv: ['Ännu en jobbansökan? Fyll i uppgifterna du redan har sparat.', 'Ett klick fyller i namn, e-post och telefon och kopplar ditt sparade CV.', 'Granska varje ändring. Ångra vid behov. Du bestämmer när formuläret skickas.', 'Fungerar med menyer, kryssrutor och fält som visas senare.', 'Börja gratis med 3 profiler. Pro för livstid kostar 39,99 USD; månads- och årsplaner finns också.'],
  th: ['สมัครงานอีกครั้งใช่ไหม กรอกข้อมูลที่บันทึกไว้ได้ทันที', 'คลิกเดียวเพื่อกรอกชื่อ อีเมล โทรศัพท์ และจับคู่เรซูเม่ที่บันทึกไว้', 'ตรวจสอบทุกการเปลี่ยนแปลง เลิกทำได้หากต้องการ คุณเป็นคนตัดสินใจว่าจะส่งเมื่อไร', 'รองรับเมนูแบบเลื่อนลง ช่องทำเครื่องหมาย และช่องที่แสดงขึ้นภายหลัง', 'เริ่มใช้ฟรี 3 โปรไฟล์ Pro แบบตลอดชีพราคา 39.99 ดอลลาร์สหรัฐ และยังมีแพ็กเกจรายเดือนกับรายปี'],
  tr: ['Bir iş başvurusu daha mı? Önceden kaydettiğiniz bilgileri doldurun.', 'Tek tıkla ad, e-posta ve telefon bilgilerini doldurun; kayıtlı CV’nizi eşleştirin.', 'Her değişikliği kontrol edin. Gerekirse geri alın. Ne zaman göndereceğinize siz karar verin.', 'Açılır listeler, onay kutuları ve sonradan açılan alanlarla çalışır.', '3 profille ücretsiz başlayın. Ömür boyu Pro 39,99 ABD dolarıdır; aylık ve yıllık planlar da vardır.'],
  uk: ['Ще одна заявка на вакансію? Заповніть уже збережені дані.', 'Одне натискання заповнює ім’я, електронну пошту й телефон та додає збережене резюме.', 'Перевірте кожну зміну. За потреби скасуйте її. Коли надсилати форму, вирішуєте ви.', 'Працює зі списками, прапорцями та полями, що з’являються пізніше.', 'Почніть безкоштовно з 3 профілями. Довічний Pro коштує 39,99 дол. США; також доступні місячний і річний плани.'],
  vi: ['Lại điền hồ sơ xin việc? Dùng ngay thông tin bạn đã lưu.', 'Một lần nhấp sẽ điền tên, email, số điện thoại và ghép CV đã lưu.', 'Kiểm tra từng thay đổi. Hoàn tác nếu cần. Bạn quyết định khi nào gửi.', 'Hoạt động với danh sách, ô chọn và các trường xuất hiện sau.', 'Bắt đầu miễn phí với 3 hồ sơ. Pro trọn đời có giá 39,99 USD; cũng có gói tháng và năm.'],
