...
const cues = {
  ...
  en: ['A blank form. One saved profile.', 'Fill repeat details and resume uploads in one click.', 'Review the result. Undo if needed. You submit.', 'Dropdowns, checkboxes, and late fields included.', 'Start free with 3 profiles. No account required.'],
  en_GB: ['A blank form. One saved profile.', 'Fill repeat details and CV uploads in one click.', 'Review the result. Undo if needed. You submit.', 'Dropdowns, checkboxes, and late fields included.', 'Start free with 3 profiles. No account required.'],
  en_US: ['A blank form. One saved profile.', 'Fill repeat details and resume uploads in one click.', 'Review the result. Undo if needed. You submit.', 'Dropdowns, checkboxes, and late fields included.', 'Start free with 3 profiles. No account required.'],
