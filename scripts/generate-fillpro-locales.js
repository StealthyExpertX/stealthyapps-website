...
const locales = [
  {
    ...
    title: 'Formulare automatisch ausfüllen mit FillPro',
    description: 'FillPro füllt Bewerbungen und wiederkehrende Webformulare aus gespeicherten Profilen aus. 3 Profile gratis, kein Konto, offline nutzbar.',
    ...
    lead: 'FillPro speichert wiederverwendbare Profile im Browser. Wähle ein Profil, fülle die Seite aus und prüfe alles, bevor du das Formular absendest.',
    ...
    features: [
      ['Mehr als Name und Adresse', 'FillPro füllt Bewerbungsfragen, Geschäftsangaben, Dropdowns, Kontrollkästchen, längere Antworten und erreichbare Datei-Uploads aus.'],
      ...
      ['Vor dem Absenden prüfen', 'FillPro füllt die Seite aus, sendet sie aber nicht ab. Du kannst ungewöhnliche Felder korrigieren oder die letzte Ausfüllung rückgängig machen.'],
    ],
  ...
  },
  {
    ...
    title: 'Autocompletar formularios con FillPro',
    description: 'FillPro autocompleta solicitudes de empleo y formularios repetitivos con perfiles guardados. 3 perfiles gratis, sin cuenta y sin conexión.',
    ...
    lead: 'FillPro guarda perfiles reutilizables en el navegador. Elige un perfil, rellena la página y revisa el resultado antes de enviar el formulario.',
    ...
    features: [
      ['Más que nombre y dirección', 'FillPro rellena preguntas de empleo, datos de empresa, menús, casillas, respuestas largas y campos de carga de archivos accesibles.'],
      ...
      ['Revisa antes de enviar', 'FillPro rellena la página, pero no la envía. Puedes corregir un campo poco habitual o deshacer el último rellenado.'],
    ],
  ...
  },
  {
    ...
    title: 'Remplissage automatique de formulaires avec FillPro',
    description: 'FillPro remplit candidatures et formulaires répétitifs depuis des profils enregistrés. 3 profils gratuits, sans compte et hors ligne.',
    ...
    lead: 'FillPro enregistre des profils réutilisables dans le navigateur. Choisissez un profil, remplissez la page, puis vérifiez le résultat avant l’envoi.',
    ...
    features: [
      ['Au-delà du nom et de l’adresse', 'FillPro remplit les questions de candidature, données d’entreprise, listes, cases, réponses longues et champs de téléversement accessibles.'],
      ...
      ['Vérifiez avant d’envoyer', 'FillPro remplit la page sans l’envoyer. Corrigez un champ inhabituel ou annulez le dernier remplissage si nécessaire.'],
    ],
  ...
  },
  {
    ...
    title: 'Preencher formulários automaticamente com FillPro',
    description: 'FillPro preenche candidaturas a vagas e formulários repetitivos com perfis salvos. 3 perfis grátis, sem conta e funciona offline.',
    ...
    lead: 'FillPro salva perfis reutilizáveis no navegador. Escolha um perfil, preencha a página e confira o resultado antes de enviar.',
    ...
    features: [
      ['Mais que nome e endereço', 'FillPro preenche perguntas de processos seletivos, dados da empresa, listas, caixas, respostas longas e campos de upload acessíveis.'],
      ...
      ['Revise antes de enviar', 'FillPro preenche a página, mas não envia o formulário. Corrija um campo incomum ou desfaça o último preenchimento.'],
    ],
  ...
  },
  {
    ...
    lead: 'FillPro は再利用できるプロフィールをブラウザに保存します。プロフィールを選んでページ上のフォームに入力し、送信前に結果を確認できます。',
    ctas: ['無料で始める', '料金を見る'],
    quickTitle: '使い方はシンプル',
    ...
    features: [
      ...
      ['送信前に確認', 'FillPro はページを入力しますが、フォームを送信しません。必要なら項目を直したり、最後の入力を元に戻したりできます。'],
    ],
  ...
  },
  {
    ...
    lead: 'FillPro는 다시 사용할 프로필을 브라우저에 저장합니다. 프로필을 고르고 페이지를 채운 뒤 제출 전에 결과를 확인하세요.',
    ctas: ['무료로 시작', '요금 보기'],
    ...
    features: [
      ...
      ['제출 전에 확인', 'FillPro는 페이지를 채우지만 제출하지 않습니다. 낯선 필드를 고치거나 마지막 입력을 되돌릴 수 있습니다.'],
    ],
  ...
  },
  {
    ...
    features: [
      ...
      ['提交前先检查', 'FillPro 负责填写页面，但不会提交表单。你可以修正特殊字段，也可以撤销上一次填写。'],
    ],
  ...
  },
  {
    ...
    title: 'Автозаполнение форм с FillPro',
    description: 'FillPro заполняет заявки и повторяющиеся веб-формы из сохранённых профилей. 3 профиля бесплатно, без аккаунта и офлайн.',
    ...
    lead: 'FillPro сохраняет многоразовые профили в браузере. Выберите профиль, заполните страницу и проверьте результат перед отправкой.',
    ...
    features: [
      ['Не только имя и адрес', 'FillPro заполняет вопросы в заявках, данные компании, списки, флажки, длинные ответы и доступные поля загрузки файлов.'],
      ...
      ['Проверка перед отправкой', 'FillPro заполняет страницу, но не отправляет форму. Можно исправить необычное поле или отменить последнее заполнение.'],
    ],
...
function localeUrl(locale) {
  return locale.slug ? `https://stealthyapps.com/fillpro/${locale.slug}/` : 'https://stealthyapps.com/fillpro/';
}

function localePath(locale) {
  return locale.slug ? `/fillpro/${locale.slug}/` : '/fillpro/';
}

function alternateLinks() {
  return [
    ...allLanguages.map((locale) => `  <link rel="alternate" hreflang="${locale.hreflang}" href="${localeUrl(locale)}">`),
    '  <link rel="alternate" hreflang="x-default" href="https://stealthyapps.com/fillpro/">',
  ].join('\n');
}
    ...
    '@graph': [
      {
        ...
        about: { '@id': 'https://stealthyapps.com/fillpro/#software' },
        dateModified: UPDATED_ISO,
      },
      {
        '@type': 'SoftwareApplication',
        '@id': 'https://stealthyapps.com/fillpro/#software',
        name: 'FillPro',
...
${alternateLinks()}
  <link rel="icon" href="/assets/fillpro-logo.svg" type="image/svg+xml">
  <link rel="apple-touch-icon" href="/assets/fillpro-logo.png">
  ...
  <meta property="og:image" content="https://stealthyapps.com/assets/fillpro-og.png">
  ...
  <meta name="twitter:image" content="https://stealthyapps.com/assets/fillpro-og.png">
...
<body class="trust-page locale-page">
  ...
  <header class="site-header">
    <nav class="nav" aria-label="${escapeHtml(product)}">
      <a class="brand" href="${localePath(locale)}" aria-label="FillPro by Stealthy Apps">
        <img class="brand-logo" src="/assets/fillpro-logo.svg" alt="" width="42" height="42" decoding="async">
        <span class="brand-lockup"><span class="brand-title">FillPro</span><span class="brand-subtitle">by Stealthy Apps</span></span>
      </a>
      <div class="nav-links">
        ...
        <a data-nav-key="contact" href="/contact/?topic=product&amp;product=FillPro">${escapeHtml(contact)}</a>
      </div>
    </nav>
  </header>
  <main id="content" tabindex="-1" class="page">
    <section class="section two-col locale-hero">
      <div class="page-intro">
        ...
        <div class="actions">
          <a class="button primary" href="/fillpro/download/">${escapeHtml(locale.ctas[0])}</a>
    ...
    <section class="section">
      <div class="section-heading"><p class="eyebrow">FillPro</p><h2>${escapeHtml(locale.faqTitle)}</h2></div>
    ...
    <section class="section">
      <div class="card locale-final"><h2>${escapeHtml(locale.finalTitle)}</h2><a class="button primary" href="/fillpro/download/">${escapeHtml(locale.finalCta)}</a></div>
    </section>
  </main>
  <footer>
...
function renderLocaleSitemap() {
  const alternates = allLanguages
    ...
    .concat('    <xhtml:link rel="alternate" hreflang="x-default" href="https://stealthyapps.com/fillpro/"/>')
    .join('\n');
...
for (const locale of locales) {
  const target = path.join(ROOT, 'fillpro', locale.slug, 'index.html');
...
if (failures.length) {
  console.error(`Localized FillPro pages are stale or missing: ${failures.join(', ')}`);
  process.exit(1);
}

console.log(`${CHECK_ONLY ? 'Checked' : 'Generated'} ${locales.length} localized FillPro pages and their sitemap.`);
