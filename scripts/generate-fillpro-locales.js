...
const locales = [
  {
    ...
    lead: 'Kontaktdaten, Lebenslauf und Antworten, die du immer wieder eingibst. Einmal speichern, aus einem Profil ausfüllen und jede Bewerbung persönlich anpassen.',
    ...
    freeTitle: 'Kostenlos', freeBody: 'Bis zu 3 gespeicherte Profile, Export und gezielte Wiederherstellung aus einem Backup innerhalb dieses Limits.',
  ...
  },
  {
    ...
    lead: 'Tus datos de contacto, tu currículum y las respuestas que escribes una y otra vez. Guárdalos una vez, rellena desde un perfil y personaliza cada solicitud.',
    ...
    freeTitle: 'Gratis', freeBody: 'Hasta 3 perfiles guardados, exportación y recuperación de perfiles seleccionados de una copia de seguridad dentro de ese límite.',
  ...
  },
  {
    ...
    lead: 'Vos coordonnées, votre CV et les réponses que vous retapez sans cesse. Enregistrez-les une fois, remplissez depuis un profil et personnalisez chaque candidature.',
    ...
    freeTitle: 'Gratuit', freeBody: 'Jusqu’à 3 profils enregistrés, export et restauration de profils sélectionnés depuis une sauvegarde, dans cette limite.',
  ...
  },
  {
    ...
    lead: 'Seus dados de contato, currículo e respostas que você digita tantas vezes. Salve uma vez, preencha a partir de um perfil e personalize cada candidatura.',
    ...
    freeTitle: 'Grátis', freeBody: 'Até 3 perfis salvos, exportação e recuperação de perfis selecionados de um backup dentro desse limite.',
  ...
  },
  {
    ...
    lead: '連絡先、履歴書、何度も入力してきた回答。まとめて保存し、プロフィールから入力して、それぞれの応募に合わせて仕上げましょう。',
    ctas: ['無料で始める', '料金を見る'],
    ...
    freeTitle: '無料', freeBody: 'プロフィールは3件まで保存できます。エクスポートと、上限内で選んだプロフィールのバックアップからの復元も無料です。',
  ...
  },
  {
    ...
    lead: '연락처, 이력서, 매번 반복해서 쓰는 답변. 한 번 저장하고 프로필로 입력한 뒤, 지원하는 곳에 맞게 다듬으세요.',
    ctas: ['무료로 시작', '요금 보기'],
    ...
    freeTitle: '무료', freeBody: '프로필을 최대 3개까지 저장할 수 있습니다. 내보내기와 이 한도 내에서 선택한 프로필의 백업 복원도 무료입니다.',
  ...
  },
  {
    ...
    h1: '不必在每个表单中重复输入相同资料。',
    lead: '联系方式、简历，还有反复填写的答案。保存一次，从资料中填入，再按每次申请的需要调整。',
    ctas: ['免费开始', '查看价格'],
    ...
    freeTitle: '免费', freeBody: '最多保存 3 个资料。导出以及在此上限内从备份恢复所选资料也免费。',
  ...
  },
  {
    ...
    lead: 'Контакты, резюме и ответы, которые приходится вводить снова и снова. Сохраните их один раз, заполните поля из профиля и доработайте каждую заявку.',
    ...
    freeTitle: 'Бесплатно', freeBody: 'До 3 сохранённых профилей, экспорт и восстановление выбранных профилей из резервной копии в пределах этого лимита.',
