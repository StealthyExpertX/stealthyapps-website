...
const locales = [
  {
    ...
    title: 'Formulare automatisch ausfüllen mit FillAhead',
    description: 'FillAhead füllt Bewerbungen und wiederkehrende Webformulare aus gespeicherten Profilen aus. 3 Profile gratis, kein Konto, offline nutzbar.',
    ...
    lead: 'FillAhead speichert wiederverwendbare Profile im Browser. Wähle ein Profil, fülle die Seite aus und prüfe alles, bevor du das Formular absendest.',
    ...
    features: [
      ['Mehr als Name und Adresse', 'FillAhead füllt Bewerbungsfragen, Geschäftsangaben, Dropdowns, Kontrollkästchen, längere Antworten und erreichbare Datei-Uploads aus.'],
      ...
      ['Vor dem Absenden prüfen', 'FillAhead füllt die Seite aus, sendet sie aber nicht ab. Du kannst ungewöhnliche Felder korrigieren oder die letzte Ausfüllung rückgängig machen.'],
    ],
    ...
    faqs: [
      ['Welche Formulare kann FillAhead ausfüllen?', 'Bewerbungen, Registrierungen, Onboarding-, Lieferanten-, Support- und andere wiederkehrende Webformulare mit erreichbaren Formularfeldern.'],
      ['Funktioniert FillAhead offline?', 'Ja. Der normale Ablauf mit gespeicherten Profilen funktioniert offline. Für Pro-Lizenzprüfungen, Support und Downloads ist eine Verbindung erforderlich.'],
      ['Ersetzt FillAhead einen Passwortmanager?', 'Nein. Anmeldedaten, Karten und Einmalcodes bleiben bei den dafür vorgesehenen Browser- und Passwortmanager-Funktionen.'],
    ],
    finalTitle: 'Das nächste lange Formular schneller erledigen.', finalCta: 'FillAhead herunterladen', languageLabel: 'Sprache', skip: 'Zum Inhalt springen', updated: 'Aktualisiert', dateLabel: '24. August 2026',
  },
  {
    slug: 'es', lang: 'es', hreflang: 'es', ogLocale: 'es_ES', languageName: 'Español',
    title: 'Autocompletar formularios con FillAhead',
    description: 'FillAhead autocompleta solicitudes de empleo y formularios repetitivos con perfiles guardados. 3 perfiles gratis, sin cuenta y sin conexión.',
    ...
    lead: 'FillAhead guarda perfiles reutilizables en el navegador. Elige un perfil, rellena la página y revisa el resultado antes de enviar el formulario.',
    ...
    features: [
      ['Más que nombre y dirección', 'FillAhead rellena preguntas de empleo, datos de empresa, menús, casillas, respuestas largas y campos de carga de archivos accesibles.'],
      ...
      ['Revisa antes de enviar', 'FillAhead rellena la página, pero no la envía. Puedes corregir un campo poco habitual o deshacer el último rellenado.'],
    ],
    ...
    faqs: [
      ['¿Qué formularios puede rellenar FillAhead?', 'Solicitudes de empleo, registros, incorporación, proveedores, soporte y otros formularios web repetitivos con campos accesibles.'],
      ['¿FillAhead funciona sin conexión?', 'Sí. El flujo normal con perfiles guardados funciona sin conexión. La licencia Pro, el soporte y las descargas necesitan conexión.'],
    ...
    finalTitle: 'Termina antes el próximo formulario largo.', finalCta: 'Descargar FillAhead', languageLabel: 'Idioma', skip: 'Saltar al contenido', updated: 'Actualizado', dateLabel: '24 de agosto de 2026',
  },
  {
    slug: 'fr', lang: 'fr', hreflang: 'fr', ogLocale: 'fr_FR', languageName: 'Français',
    title: 'Remplissage automatique de formulaires avec FillAhead',
    description: 'FillAhead remplit candidatures et formulaires répétitifs depuis des profils enregistrés. 3 profils gratuits, sans compte et hors ligne.',
    ...
    lead: 'FillAhead enregistre des profils réutilisables dans le navigateur. Choisissez un profil, remplissez la page, puis vérifiez le résultat avant l’envoi.',
    ...
    features: [
      ['Au-delà du nom et de l’adresse', 'FillAhead remplit les questions de candidature, données d’entreprise, listes, cases, réponses longues et champs de téléversement accessibles.'],
      ...
      ['Vérifiez avant d’envoyer', 'FillAhead remplit la page sans l’envoyer. Corrigez un champ inhabituel ou annulez le dernier remplissage si nécessaire.'],
    ],
    ...
    faqs: [
      ['Quels formulaires FillAhead peut-il remplir ?', 'Candidatures, inscriptions, intégration, fournisseurs, support et autres formulaires web répétitifs dont les champs sont accessibles.'],
      ['FillAhead fonctionne-t-il hors ligne ?', 'Oui. Le parcours normal avec les profils enregistrés fonctionne hors ligne. La licence Pro, le support et les téléchargements nécessitent une connexion.'],
      ['FillAhead remplace-t-il un gestionnaire de mots de passe ?', 'Non. Les identifiants, cartes et codes à usage unique restent dans les outils conçus pour ces données.'],
    ],
    finalTitle: 'Terminez plus vite votre prochain formulaire.', finalCta: 'Télécharger FillAhead', languageLabel: 'Langue', skip: 'Aller au contenu', updated: 'Mis à jour', dateLabel: '24 août 2026',
  },
  {
    slug: 'pt-br', lang: 'pt-BR', hreflang: 'pt-BR', ogLocale: 'pt_BR', languageName: 'Português (Brasil)',
    title: 'Preencher formulários automaticamente com FillAhead',
    description: 'FillAhead preenche candidaturas a vagas e formulários repetitivos com perfis salvos. 3 perfis grátis, sem conta e funciona offline.',
    ...
    lead: 'FillAhead salva perfis reutilizáveis no navegador. Escolha um perfil, preencha a página e confira o resultado antes de enviar.',
    ...
    features: [
      ['Mais que nome e endereço', 'FillAhead preenche perguntas de processos seletivos, dados da empresa, listas, caixas, respostas longas e campos de upload acessíveis.'],
      ...
      ['Revise antes de enviar', 'FillAhead preenche a página, mas não envia o formulário. Corrija um campo incomum ou desfaça o último preenchimento.'],
    ],
    ...
    faqs: [
      ['Quais formulários o FillAhead preenche?', 'Candidaturas a vagas, cadastros, integração, fornecedores, suporte e outros formulários web repetitivos com campos acessíveis.'],
      ['O FillAhead funciona offline?', 'Sim. O fluxo normal com perfis salvos funciona offline. Licença Pro, suporte e downloads precisam de conexão.'],
      ['O FillAhead substitui um gerenciador de senhas?', 'Não. Logins, cartões e códigos de uso único continuam nas ferramentas criadas para esses dados.'],
    ],
    finalTitle: 'Termine o próximo formulário longo mais rápido.', finalCta: 'Baixar FillAhead', languageLabel: 'Idioma', skip: 'Pular para o conteúdo', updated: 'Atualizado', dateLabel: '24 de agosto de 2026',
  },
  {
    slug: 'ja', lang: 'ja', hreflang: 'ja', ogLocale: 'ja_JP', languageName: '日本語',
    title: 'フォーム自動入力なら FillAhead',
    ...
    lead: 'FillAhead は再利用できるプロフィールをブラウザに保存します。プロフィールを選んでページ上のフォームに入力し、送信前に結果を確認できます。',
    ctas: ['無料で始める', '料金を見る'],
    quickTitle: '使い方はシンプル',
    ...
    features: [
      ...
      ['送信前に確認', 'FillAhead はページを入力しますが、フォームを送信しません。必要なら項目を直したり、最後の入力を元に戻したりできます。'],
    ],
    ...
    finalTitle: '次の長いフォームを、もっと短時間で。', finalCta: 'FillAhead をダウンロード', languageLabel: '言語', skip: '本文へ移動', updated: '更新日', dateLabel: '2026年8月24日',
  },
  {
    slug: 'ko', lang: 'ko', hreflang: 'ko', ogLocale: 'ko_KR', languageName: '한국어',
    title: 'FillAhead로 양식 자동완성',
    ...
    lead: 'FillAhead는 다시 사용할 프로필을 브라우저에 저장합니다. 프로필을 고르고 페이지를 채운 뒤 제출 전에 결과를 확인하세요.',
    ctas: ['무료로 시작', '요금 보기'],
    ...
    features: [
      ...
      ['제출 전에 확인', 'FillAhead는 페이지를 채우지만 제출하지 않습니다. 낯선 필드를 고치거나 마지막 입력을 되돌릴 수 있습니다.'],
    ],
    ...
    finalTitle: '다음 긴 양식을 더 빨리 끝내세요.', finalCta: 'FillAhead 다운로드', languageLabel: '언어', skip: '본문으로 건너뛰기', updated: '업데이트', dateLabel: '2026년 8월 24일',
  },
  {
    slug: 'zh-cn', lang: 'zh-CN', hreflang: 'zh-CN', ogLocale: 'zh_CN', languageName: '简体中文',
    title: '用 FillAhead 自动填充表单',
    description: 'FillAhead 使用已保存的个人资料填写求职申请、注册和常用网页表单。可免费保存 3 个资料，无需注册，也可离线使用，提交前可检查或撤销。',
    nav: ['产品', '下载', '价格', '隐私', '支持', '联系'],
    legal: ['条款', '退款'],
    kicker: '表单自动填充，资料保存在扩展程序中',
    h1: '不必在每个表单中重复输入相同资料。',
    lead: 'FillAhead 将可重复使用的个人资料保存在浏览器扩展中。选择资料、填写页面，然后在提交前检查结果。',
    ctas: ['免费开始', '查看价格'],
    quickTitle: '更短的操作流程',
    ...
    features: [
      ...
      ['提交前先检查', 'FillAhead 负责填写页面，但不会提交表单。你可以修正特殊字段，也可以撤销上一次填写。'],
    ],
    ...
    faqTitle: '常见问题',
    faqs: [
      ['FillAhead 可以填写哪些表单？', '可用于求职申请、注册、入职、供应商、支持等带有可访问字段的重复网页表单。'],
      ['FillAhead 可以离线使用吗？', '可以。使用已保存资料的日常填写可离线运行。Pro 许可证检查、支持和下载需要联网。'],
      ['FillAhead 会替代密码管理器吗？', '不会。登录信息、银行卡和一次性验证码仍由专门处理这些数据的浏览器功能或密码管理器负责。'],
    ],
    finalTitle: '更快完成下一个长表单。', finalCta: '下载 FillAhead', languageLabel: '语言', skip: '跳到主要内容', updated: '更新日期', dateLabel: '2026年8月24日',
  },
  {
    slug: 'ru', lang: 'ru', hreflang: 'ru', ogLocale: 'ru_RU', languageName: 'Русский',
    title: 'Автозаполнение форм с FillAhead',
    description: 'FillAhead заполняет заявки и повторяющиеся веб-формы из сохранённых профилей. 3 профиля бесплатно, без аккаунта и офлайн.',
    ...
    lead: 'FillAhead сохраняет многоразовые профили в браузере. Выберите профиль, заполните страницу и проверьте результат перед отправкой.',
    ...
    features: [
      ['Не только имя и адрес', 'FillAhead заполняет вопросы в заявках, данные компании, списки, флажки, длинные ответы и доступные поля загрузки файлов.'],
      ...
      ['Проверка перед отправкой', 'FillAhead заполняет страницу, но не отправляет форму. Можно исправить необычное поле или отменить последнее заполнение.'],
    ],
    ...
    faqs: [
      ['Какие формы заполняет FillAhead?', 'Заявки на работу, регистрации, онбординг, формы поставщиков, поддержки и другие повторяющиеся веб-формы с доступными полями.'],
      ['FillAhead работает офлайн?', 'Да. Обычное заполнение из сохранённых профилей работает офлайн. Для проверки Pro, поддержки и загрузок требуется подключение.'],
      ['FillAhead заменяет менеджер паролей?', 'Нет. Логины, карты и одноразовые коды остаются в браузере и менеджере паролей, созданных для этих данных.'],
    ],
    finalTitle: 'Закончите следующую длинную форму быстрее.', finalCta: 'Скачать FillAhead', languageLabel: 'Язык', skip: 'Перейти к содержимому', updated: 'Обновлено', dateLabel: '24 августа 2026 г.',
  },
];
...
function localeUrl(locale) {
  return locale.slug ? `https://stealthyapps.com/fillahead/${locale.slug}/` : 'https://stealthyapps.com/fillahead/';
}

function localePath(locale) {
  return locale.slug ? `/fillahead/${locale.slug}/` : '/fillahead/';
}

function alternateLinks() {
  return [
    ...allLanguages.map((locale) => `  <link rel="alternate" hreflang="${locale.hreflang}" href="${localeUrl(locale)}">`),
    '  <link rel="alternate" hreflang="x-default" href="https://stealthyapps.com/fillahead/">',
  ].join('\n');
}
    ...
    '@graph': [
      {
        ...
        about: { '@id': 'https://stealthyapps.com/fillahead/#software' },
        dateModified: UPDATED_ISO,
      },
      {
        '@type': 'SoftwareApplication',
        '@id': 'https://stealthyapps.com/fillahead/#software',
        name: 'FillAhead',
        url: 'https://stealthyapps.com/fillahead/',
...
${alternateLinks()}
  <link rel="icon" href="/assets/fillahead-logo.svg" type="image/svg+xml">
  <link rel="apple-touch-icon" href="/assets/fillahead-logo.png">
  ...
  <meta property="og:image" content="https://stealthyapps.com/assets/fillahead-og.png">
  ...
  <meta name="twitter:image" content="https://stealthyapps.com/assets/fillahead-og.png">
...
<body class="trust-page locale-page">
  ...
  <header class="site-header">
    <nav class="nav" aria-label="${escapeHtml(product)}">
      <a class="brand" href="${localePath(locale)}" aria-label="FillAhead by Stealthy Apps">
        <img class="brand-logo" src="/assets/fillahead-logo.svg" alt="" width="42" height="42" decoding="async">
        <span class="brand-lockup"><span class="brand-title">FillAhead</span><span class="brand-subtitle">by Stealthy Apps</span></span>
      </a>
      <div class="nav-links">
        <a data-nav-key="product" href="${localePath(locale)}" aria-current="page">${escapeHtml(product)}</a>
        <a data-nav-key="download" href="/fillahead/download/">${escapeHtml(download)}</a>
        <a data-nav-key="pricing" href="#pricing">${escapeHtml(pricing)}</a>
        <a data-nav-key="privacy" href="/fillahead/privacy/">${escapeHtml(privacy)}</a>
        <a data-nav-key="support" href="/support/">${escapeHtml(support)}</a>
        <a data-nav-key="contact" href="/contact/?topic=product&amp;product=FillAhead">${escapeHtml(contact)}</a>
      </div>
    </nav>
  </header>
  <main id="content" tabindex="-1" class="page">
    <section class="section two-col locale-hero">
      <div class="page-intro">
        ...
        <div class="actions">
          <a class="button primary" href="/fillahead/download/">${escapeHtml(locale.ctas[0])}</a>
    ...
    <section class="section">
      <div class="section-heading"><p class="eyebrow">FillAhead</p><h2>${escapeHtml(locale.faqTitle)}</h2></div>
    ...
    <section class="section">
      <div class="card locale-final"><h2>${escapeHtml(locale.finalTitle)}</h2><a class="button primary" href="/fillahead/download/">${escapeHtml(locale.finalCta)}</a></div>
    </section>
  </main>
  <footer>
    <div class="footer-inner">
      <div class="footer-copy"><strong>FillAhead by Stealthy Apps</strong><span>${escapeHtml(locale.updated)} <time datetime="${UPDATED_ISO}">${escapeHtml(locale.dateLabel)}</time>.</span></div>
      <nav class="footer-links" aria-label="Footer">
        <a data-nav-key="product" href="${localePath(locale)}">${escapeHtml(product)}</a>
        <a data-nav-key="download" href="/fillahead/download/">${escapeHtml(download)}</a>
        <a data-nav-key="pricing" href="#pricing">${escapeHtml(pricing)}</a>
        <a data-nav-key="privacy" href="/fillahead/privacy/">${escapeHtml(privacy)}</a>
        <a data-nav-key="terms" href="/fillahead/terms/">${escapeHtml(terms)}</a>
        <a data-nav-key="refunds" href="/fillahead/refunds/">${escapeHtml(refunds)}</a>
        <a data-nav-key="support" href="/support/">${escapeHtml(support)}</a>
...
function renderLocaleSitemap() {
  const alternates = allLanguages
    ...
    .concat('    <xhtml:link rel="alternate" hreflang="x-default" href="https://stealthyapps.com/fillahead/"/>')
    .join('\n');
...
for (const locale of locales) {
  const target = path.join(ROOT, 'fillahead', locale.slug, 'index.html');
...
if (failures.length) {
  console.error(`Localized FillAhead pages are stale or missing: ${failures.join(', ')}`);
  process.exit(1);
}

console.log(`${CHECK_ONLY ? 'Checked' : 'Generated'} ${locales.length} localized FillAhead pages and their sitemap.`);
