...
const VERSION = 'fillpro-launch-v44-2026-07-07';
const CORE_ASSETS = [
  '/',
  '/fillpro/',
  '/fillpro/download/',
  ...
  '/support/',
  '/contact/',
  '/styles.css?v=fillpro-launch-v44',
  '/site.js?v=fillpro-launch-v44',
  '/fillpro-hero-scene.js?v=fillpro-launch-v44',
  '/vendor/three.module.min.js',
  '/vendor/three.core.min.js',
  '/contact.js?v=fillpro-launch-v44',
