...
const VERSION = 'fillpro-site-v15-2026-06-12';
const CORE_ASSETS = [
  '/',
  '/extensions/fillpro/',
  '/extensions/fillpro/privacy/',
  '/support/',
  '/contact/',
  '/styles.css?v=fillpro-site-v15',
  '/site.js?v=fillpro-site-v15',
  '/contact.js?v=fillpro-site-v15',
