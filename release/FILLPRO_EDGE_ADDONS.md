# FillPro Microsoft Edge Add-ons Submission

Upload package: `dist/fillpro-edge.zip`
...
Use the same core screenshots and promo art:
...
- The Edge package is built from the Chrome Manifest V3 source.
- Keep the public website URL as `https://stealthyapps.com/fillpro/`.
- Keep the same pricing language as Chrome so users do not see conflicting terms.
