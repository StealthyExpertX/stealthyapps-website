...
- Bumped the website cache token to `fillpro-launch-v47` for the updated CSS, JS, and service worker asset references.
...
- Fixed the live Three.js hero render after direct canvas review showed the object was over-complex and clipped: reduced the form stack, lowered material/light weight, recentered the object, moved the canvas onto the hero background plane, modestly raised final opacity, and re-verified desktop/mobile light/dark hero screenshots plus direct WebGL pixel checks.
