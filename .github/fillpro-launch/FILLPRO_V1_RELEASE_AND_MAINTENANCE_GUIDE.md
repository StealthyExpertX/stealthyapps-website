# Skip Retyping v1.0.0 Release and Maintenance Guide

Date: 2026-06-14

## Daily Release Rule

Keep Skip Retyping at `1.0.0` for the initial release. Do not bump the version unless there is a real user-facing fix or you explicitly choose to ship a new store update.
...
- Product URL: `https://stealthyapps.com/skip-retyping/`
- Support URL: `https://stealthyapps.com/support/`
- Privacy URL: `https://stealthyapps.com/skip-retyping/privacy/`
...
Use one 20-35 second clip: start with a realistic long form, open Skip Retyping, choose a profile, fill safe fields, show the upload match, show password/payment fields untouched, finish on review-before-submit.
...
git status
git add .
git commit -m "Polish Skip Retyping v1 launch site"
...
git status
git add .
git commit -m "Harden Skip Retyping v1 launch extension"
git push origin main
```
